...
export function service_toJSON(a: number): number;
export function service_fromJSON(a: number): number;
...
export function document_removeService(a: number, b: number): void;
...
export function verificationmethod_new(a: number, b: number, c: number): number;
export function verificationmethod_fromDID(a: number, b: number, c: number, d: number): number;
export function verificationmethod_createMerkleKey(a: number, b: number, c: number, d: number, e: number): number;
export function verificationmethod_id(a: number): number;
export function verificationmethod_controller(a: number): number;
export function verificationmethod_type(a: number, b: number): void;
export function verificationmethod_data(a: number): number;
export function verificationmethod_toJSON(a: number): number;
export function verificationmethod_fromJSON(a: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h99e0719bb9d2ebec(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h20573bf012e1e5b2(a: number, b: number, c: number, d: number): void;
